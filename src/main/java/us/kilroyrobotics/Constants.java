...
public final class Constants {
	...
	public static final class ElevatorConstants {
		...
		public static final Distance kCoralStationHeight =
				Meters.of(Inches.of(31.6875).in(Meters));
	...
	public static final class SimulationConstants {
		...
		public static final Distance kElevatorDrumRadius =
				Meters.of(Inches.of(2.0).in(Meters));

		/** The minimum height of the elevator in Meters */
		public static final Distance kElevatorMinHeight =
				Meters.of(Inches.of(0.0).in(Meters));

		/** The maximum height of the elevator in Meters */
		public static final Distance kElevatorMaxHeight =
				Meters.of(Inches.of(74.5).in(Meters));

		/** The height of the elevator in Meters when the robot is in its starting configuration */
		public static final Distance kElevatorStartingHeight =
				Meters.of(Inches.of(0.0).in(Meters));
